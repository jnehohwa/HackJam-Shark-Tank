...
import { Trophy, Medal, Award, TrendingUp, Lightbulb, ArrowLeft, Loader2 } from "lucide-react";
...
const BADGES_INFO = [
  ...
  { name: "First Idea", description: "Submit your first idea", icon: Lightbulb, color: "bg-blue-500" },
  { name: "Engaged Voter", description: "Cast 50+ votes", icon: Trophy, color: "bg-green-500" },
];
    ...
    >
      <div className="mb-4 relative">
        <div
          ...
          } bg-gradient-primary flex items-center justify-center text-white font-bold text-2xl`}
        >
          {user.name.charAt(0)}
        </div>
        <div
